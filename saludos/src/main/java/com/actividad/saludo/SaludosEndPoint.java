...
public class SaludosEndPoint {
    int id = 0;
    ArrayList<BuscarSaludosResponse.Saludo> saludos = new ArrayList<BuscarSaludosResponse.Saludo>(); // Create an
                                                                                                     // ArrayList object
    ...
    public SaludarResponse saludar(@RequestPayload SaludarRequest nombre) {
        ...
        BuscarSaludosResponse.Saludo saludo = new BuscarSaludosResponse.Saludo();
        saludo.setId(id);
